      ...
      <nav className="sticky top-0 z-50 bg-white shadow-sm px-6 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link to={base} className="text-lg font-bold" style={{ color: colors.primary }}>{b.name}</Link>
          </div>
          ...
          <section className="min-h-[80vh] flex items-center px-6" style={{ background: `linear-gradient(160deg, ${colors.accent} 0%, ${colors.background} 100%)` }}>
            <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center py-20">
              <div>
                ...
                <Link to={`${base}/contact`} className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-semibold transition-transform hover:scale-105" style={{ backgroundColor: colors.primary, color: colors.primaryForeground }}>
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mt-12">
              <Link to={`${base}/contact`} className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full font-medium" style={{ backgroundColor: colors.primary, color: colors.primaryForeground }}>{hero.cta} <ArrowRight className="w-4 h-4" /></Link>
            </div>
          </div>
        </section>
      )}
