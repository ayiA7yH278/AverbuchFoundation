      ...
      <nav className="sticky top-0 z-50 bg-white shadow-sm px-6 py-3">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link to={base} className="text-lg font-bold" style={{ fontFamily: fonts.heading, color: colors.primary }}>{b.name}</Link>
          </div>
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to={`${base}/contact`} className="px-5 py-2 rounded-lg text-sm font-medium" style={{ backgroundColor: colors.primary, color: colors.primaryForeground }}>Contact Us</Link>
          </div>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-28 relative z-10">
              <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 grid md:grid-cols-3 gap-8 items-start">
                <div className="md:col-span-2">
                  ...
                  <Link to={`${base}/services`} className="inline-flex items-center gap-2 mt-6 text-sm font-medium hover:gap-3 transition-all" style={{ color: colors.primary }}>{hero.cta} <ArrowRight className="w-4 h-4" /></Link>
                </div>
