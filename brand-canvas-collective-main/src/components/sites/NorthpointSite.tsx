...
export default function NorthpointSite({ business: b, page }: Props) {
  ...
  const links = [
    ...
    { path: `/${slug}/services`, label: 'Capabilities', pg: 'services' },
  ...
  return (
    <div style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.foreground }}>
      ...
      <nav className="sticky top-0 z-50 px-6 py-3 border-b" style={{ backgroundColor: colors.background, borderColor: `${colors.muted}20` }}>
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link to={`/${slug}`} className="text-lg font-bold flex items-center gap-2" style={{ fontFamily: fonts.heading, color: colors.primary }}>
        ...
        <>
          ...
          <section className="relative min-h-[70vh] flex items-center px-6 overflow-hidden" style={{ backgroundColor: colors.accent }}>
            ...
            <div className="max-w-3xl relative z-10 py-20">
              ...
              <Link to={`/${slug}/contact`} className="inline-flex items-center gap-2 px-7 py-3.5 rounded text-sm font-medium" style={{ backgroundColor: colors.primary, color: colors.primaryForeground }}>{hero.cta} <ArrowRight className="w-4 h-4" /></Link>
            </div>
          </section>
      ...
      <footer className="py-8 px-6 border-t" style={{ borderColor: `${colors.muted}20` }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm opacity-50">{b.name} © 2026 Enterprise</p>
